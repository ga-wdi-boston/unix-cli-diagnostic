...
<!-- Answer Starts Here -->
Yes it was deleted when I wrote the command rm -rf temp
<!-- Answer Ends Here -->
...
1. Is `/Users/blah_blah/Desktop` a relative path or an absolute path? How do you know?
 ...
 <!-- Answer Starts Here -->
This is an absolute path because it begins with '/'
 <!-- Answer Ends Here -->
...
If we are in the `project` directory and use `cd planning`, is a relative or absolute path being referenced? How do you know?
 ...
 <!-- Answer Starts Here -->
A relative path is being referenced because you are changing directory based on where you currently are (project) and not based on the root directory.
 <!-- Answer Ends Here -->

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

 <!-- Answer Starts Here -->
We would use a relative path because we are referring to a file in the project folder.
 <!-- Answer Ends Here -->
