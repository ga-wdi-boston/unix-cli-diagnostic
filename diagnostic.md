...
5. Great Work!  Back in the terminal, do  `git status` to view your changes.  What color is the file name?
 ...
 <!-- Answer Starts Here -->
The DIRECTORY cli-diagnostic is red.
 <!-- Answer Ends Here -->
...
6. Do `git add <file_name>`  to stage your changes.  Do `git status` again to see the newly staged file.  What color is the file name now?
 ...
 <!-- Answer Starts Here -->
The files within the cli-dianotic folder (rhyme.txt and diagnostic.md in the temp folder) are now green.
 <!-- Answer Ends Here -->
...
<!-- Answer Starts Here -->
Yes, but I've accidentally deleted my diagnostic.md as well.(?)
<!-- Answer Ends Here -->
