...
1. Is `/Users/blah_blah/Desktop` a relative path or an absolute path? How do you know?
 ...
 <!-- Answer Starts Here -->
It is an absolute path. It starts with / which represents the root directory.
 <!-- Answer Ends Here -->
...
If we are in the `project` directory and use `cd planning`, is a relative or absolute path being referenced? How do you know?
 ...
 <!-- Answer Starts Here -->
Relative. We are not specifying the complete file path. I only told the computer to go from the project directory to the planning directory.
 <!-- Answer Ends Here -->

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

 <!-- Answer Starts Here -->
Either one would work. It depends what I was doing. If I want to refer to the image file later, from another directory, I would use an absolute path.
If I'm currently in the planning directory a relative path should work.
 <!-- Answer Ends Here -->
