...
<!-- Answer Starts Here -->
  Yes it was deleted (had to use -r)
<!-- Answer Ends Here -->
...
1. Is `/Users/blah_blah/Desktop` a relative path or an absolute path? How do you know?
 ...
 <!-- Answer Starts Here -->
  It is an absolute path because it starts with a '/'
 <!-- Answer Ends Here -->
...
If we are in the `project` directory and use `cd planning`, is a relative or absolute path being referenced? How do you know?
 ...
 <!-- Answer Starts Here -->
  Relative path.  Because where we go next depends on the directory we are in.
 <!-- Answer Ends Here -->

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

 <!-- Answer Starts Here -->
  Relative path, because if the project was moved (like if it was added to github) then the absolute path would change and the image file reference would no longer work.  A relative path doesn't care where the project is located.
 <!-- Answer Ends Here -->
