...
1. Is `/Users/blah_blah/Desktop` a relative path or an absolute path? How do you know?
 ...
 <!-- Answer Starts Here -->
 Rellative path depends on the path we are. Absolute paths doesnt change according to our position.
 <!-- Answer Ends Here -->
 ...
 <!-- Answer Starts Here -->
It is an absolute path becaue it does't matter our directory in our computer, this path still remains the same
 <!-- Answer Ends Here -->

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

 <!-- Answer Starts Here -->
The image on our computer is an relative path because it depends on from whre we are copying and to which point 
 <!-- Answer Ends Here -->
