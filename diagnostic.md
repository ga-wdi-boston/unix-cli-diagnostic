...
1. Is `/Users/blah_blah/Desktop` a relative path or an absolute path? How do you know?
 ...
 <!-- Answer Starts Here -->
Absolute path - the full path is shown back to the root directory and starts with the root directory.
 <!-- Answer Ends Here -->
...
If we are in the `project` directory and use `cd planning`, is a relative or absolute path being referenced? How do you know?
 ...
 <!-- Answer Starts Here -->
Relative path - we are changing directories relative to our position into 'project' and not giving an absolute path. The absolute path for change to this directory would be cd /project/planning
 <!-- Answer Ends Here -->

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

 <!-- Answer Starts Here -->
We should refer to it using a relative path. This is in case the project directory is moved or linked.
 <!-- Answer Ends Here -->
