...
If we are in the `project` directory and use `cd planning`, is a relative or absolute path being referenced? How do you know?
 ...
 <!-- Answer Starts Here -->
relative because it's relative to project.  cd planning wouldn't work if you were in another directory like js
 <!-- Answer Ends Here -->

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

 <!-- Answer Starts Here -->
relative.  you don't want to use absolute references because if the server name changes it will break the image
 <!-- Answer Ends Here -->
