...
It is relative path, since the path does not have https:// in the beginning.
...
It is absolute path, since it starts with https://.

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

We would refer to it with an relative path, since the image file stores in the local storage. 
