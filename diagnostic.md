...
Absolute path. Path starts with a leading "/".
...
Relative path. There is no leading "/" and the path is in reference to my current location, inside the 'Project' directory.

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

Relative path. Ensures that if someone else were to work on this project the reference to the img doesn't break because they don't have access to the absolute path created via my device.
