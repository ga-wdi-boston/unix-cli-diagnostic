...
this is an absolute paths list the full path regardless of the directory you're in  vs a relative path that is relative to where in the dir you are.
 <!-- Answer Ends Here -->
...
It's an absotule path, because it's a direct address to where the font is.
 <!-- Answer Ends Here -->

3. Now suppose that we have an image file living inside our project. Would we refer to it with an absolute or relative path? Why?

I think relative because it exists in our project.
 <!-- Answer Ends Here -->
