...
5. Great Work!  Back in the terminal, do  `git status` to view your changes.  What color is the file name?
 ...
 <!-- Answer Starts Here -->
  There is no file in unix-cli-diagnostic. But there is the directory cli-diagnostic and its name is red.
 <!-- Answer Ends Here -->
...
6. Do `git add <file_name>`  to stage your changes.  Do `git status` again to see the newly staged file.  What color is the file name now?
 ...
 <!-- Answer Starts Here -->
    cli-diagnostic/rhyme.txt and cli-diagnostic/temp/temp.md is green
 <!-- Answer Ends Here -->
...
<!-- Answer Starts Here -->
  'temp' was deleted. I used rm -r temp/ to remove the directory and the file inside.
<!-- Answer Ends Here -->
